...
<div id="form_container" style"height:350px;">
        ...
        <h1 id="paso1" class="titulo_procesos titulo_activo" style="z-index:10;background-color: #5F5F5F;">Recovery password/user</h1>
					...
					<div style="width:100%; margin:auto;">
		        		<li class="items_procesos pass"> 
							...
							<li class="item_proceso_btn"  style="width:450px;" >
								...
								<input id="saveForm2" class="button_text" type="submit" name="saveForm" value="continue" style="float:left;margin-top: 62px;" tabindex="3"/>
							</li>
		          	</li>
	          	</div>
				</td>
