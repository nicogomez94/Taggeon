...
<div id="form_container" style"height:350px;">
        ...
        <h1 id="paso1" class="titulo_procesos titulo_activo" style="z-index:10;background-color: #5F5F5F;">Editar contrase&ntilde;a</h1>
		<form id="form_465818" class="appnitro"  method="post" action="editar_pass_retailer.php">
		  ...
		  <table width="795" border="0" align="center" cellpadding="0" cellspacing="2">
		    <tr align="left">
		      <td width="100px"><span class="items_procesos"> <span class="campo_obligatorio">
		        <label class="description" for="password">*</label></span><label class="description" for="pass">contrase&ntilde;a</label>
	          </span></td>
		    ...
		    <tr align="left">
		      <td><span class="items_procesos"> <span class="campo_obligatorio">
		        <label class="description" for="password2">*</label></span><label class="description" for="pass2">confirmar contrase&ntilde;a</label>
	          </span></td>
		      <td><span class="items_procesos">
					...
					<div style="width:100%; margin:auto;">
		        		<li class="items_procesos pass"> 
							...
							<li class="item_proceso_btn"  style="width:450px;" >
								...
								<input id="saveForm2" class="button_text" type="submit" name="saveForm" value="continuar" style="float:left;margin-top: 40px;" tabindex="4"/>
							</li>
		          	</li>
	          	</div>
				</td>
