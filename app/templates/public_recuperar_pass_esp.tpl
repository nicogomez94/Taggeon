		  ...
		  <table width="795" border="0" align="center" cellpadding="0" cellspacing="2">
		    <tr align="left">
		      <td width="100px"><span class="items_procesos"> <span class="campo_obligatorio">
		        <label class="description" for="password">*</label></span><label class="description" for="password">contraseña</label>
	          </span></td>
		      <td><span class="items_procesos">
		        <input name="password" type="password" class="element text medium" id="password" value="{password}" size="30" maxlength="12" tabindex="1"/> (más de 5 caracteres)
	          </span></td>
	        </tr>
		    <tr align="left">
		      <td><span class="items_procesos"> <span class="campo_obligatorio">
		        <label class="description" for="password2">*</label></span><label class="description" for="password2">confirmar contraseña</label>
	          </span></td>
		      <td><span class="items_procesos">
					...
					<div style="width:100%; margin:auto;">
		        		<li class="items_procesos pass"> 
							...
							<li class="item_proceso_btn"  style="width:450px;" >
								...
								<input id="saveForm2" class="button_text" type="submit" name="saveForm" value="continuar" style="float:left;margin-top: 62px;" tabindex="4"/>
							</li>
		          	</li>
	          	</div>
				</td>
