...
<div id="form_container" style"height:400px;">
        ...
        <h1 id="paso1" class="titulo_procesos titulo_activo" style="z-index:10;background-color: #5F5F5F;">editar retailer</h1>
		<form id="form_465844" class="appnitro"  method="post" action="editar_retailer.php">
