<section style=" background-image: url(/wp-content/themes/mandaseguro/img/bg_proceso_large_blank-02.png);background-repeat:no-repeat;color:#686464; font-size:14px;height:400px;" class="contenedor_procesos">
...
<div id="form_container" style"height:400px;">
		...
		<form id="form_465818" class="appnitro"  method="post" action="editar_cliente.php">
