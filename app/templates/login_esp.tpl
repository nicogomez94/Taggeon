...
<div id="form_container" style"height:350px;">
	<h1 id="paso1" class="titulo_procesos titulo_activo" style="z-index:10;background-color: #5F5F5F;">ingresar</h1>
	  ...
	  <table width="795" border="0" align="center" cellpadding="0" cellspacing="2">
		    ...
		    <tr>
		      <td colspan="2" align="left"> 
					<span class="items_procesos"> 
		        		<label class="description" for="usuario">usario</label>
	          	</span><br>
					<span class="items_procesos">
		    ...
		    <tr>
		      <td width="100px" align="left">
					<span class="items_procesos"> 
						<label class="description" for="recordarme">recordarme</label>
	          	</span><br>
		       	<input type="checkbox" name="recordarme" value="recordarme"> 
				</td>
		      <td align="left">
					<div style="width: 580px;float: right;"><li class="item_proceso_btn"><input type="submit" value="ingresar" tabindex="4"/></li></div>
				</td>
	        </tr>
	        <tr>
		      <td align="left" colspan="2" valign="middle">
					<div class="olvide_clave" style="width: 200px;float: left;"><div class="flecha"><a href="/app/public_recuperar.php">olvide mi contraseña/usuario<img src="/wp-content/themes/mandaseguro/img/flecha.png" width="10" height="10" border="0"></a></div></div>
				</td>
	        </tr>
	      </table>
        </ul>
