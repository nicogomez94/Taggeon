...
<div id="form_container" style"height:350px;">
        ...
        <h1 id="paso1" class="titulo_procesos titulo_activo" style="z-index:10;background-color: #5F5F5F;">Recovery password</h1>
		<form id="form_465818" class="appnitro"  method="post" action="public_recuperar_pass.php">
		  ...
		  <table width="795" border="0" align="center" cellpadding="0" cellspacing="2">
		    <tr align="left">
		      <td width="100px"><span class="items_procesos"> <span class="campo_obligatorio">
		        <label class="description" for="password">*</label></span><label class="description" for="password">password</label>
	          </span></td> 
		      <td><span class="items_procesos">
		        <input name="password" type="password" class="element text medium" id="password" value="{password}" size="30" maxlength="12" tabindex="1"/> (More than 5 characters)
	          </span></td>
	        </tr>
		    <tr align="left">
		      <td><span class="items_procesos"> <span class="campo_obligatorio">
		        <label class="description" for="password2">*</label></span><label class="description" for="password2">confirm password</label>
	          </span></td>
		      <td><span class="items_procesos">
		        <input name="password2" type="password" class="element text medium" id="password2" value="{password2}" size="30" maxlength="12" tabindex="2"/>
	          </span></td>
	        </tr>
	        <tr>
					...
					<div style="width:100%; margin:auto;">
		        		<li class="items_procesos pass"> 
							...
							<li class="item_proceso_btn"  style="width:450px;" >
								...
								<input id="saveForm2" class="button_text" type="submit" name="saveForm" value="continue" style="float:left;margin-top: 62px;" tabindex="4"/>
							</li>
		          	</li>
	          	</div>
				</td>
