...
<div id="form_container" style"height:350px;">
        ...
        <h1 id="paso1" class="titulo_procesos titulo_activo" style="z-index:10;background-color: #5F5F5F;">registrese y cree su nueva cuenta</h1>
		  ...
		  <table width="795" border="0" align="center" cellpadding="0" cellspacing="2">
		    ...
		    <tr align="left">
		      ...
		      <td><span class="items_procesos pass">
		        <label class="description" for="pass"><span class="items_procesos"> <span class="campo_obligatorio"> *</span></span>contraseña</label>
	          </span></td>
		      <td><span class="items_procesos pass">
		        <input id="pass" name="pass" class="element text medium" type="password" maxlength="12" value="{password}" style="width: 130px;" tabindex="6"/>&nbsp;(más de 5 caracteres)
	          </span></td>
	        </tr>
		    <tr align="left">
		      <td><span class="items_procesos">
		      ...
		      <td><span class="items_procesos pass">
		        <label class="description" for="pass2"><span class="items_procesos"> <span class="campo_obligatorio"> *</span></span>confirmar contraseña</label>
	          </span></td>
		      <td><span class="items_procesos pass">
		    ...
		    <tr align="left">
		      <td valign="top"><span class="items_procesos">
		        <label class="description" for="confirmaremail"><span class="campo_obligatorio">*</span>confirmar e-mail</label>
	          </span></td>
		      <td valign="top"><span class="items_procesos">
              ...
              <div style="font-size:12px; color:#666; text-align:Left;"><input id="readterminos" name="readterminos" type="checkbox" value="leido" />he leído y aceptado los <a href="/pop_legales/index.html" style="text-decoration:underline;" class="click">terminos y condiciones de MandaSeguro.com</a></div>
					...
					<div style="width:400px; margin:auto;">
		        		<li class="items_procesos pass"> 
							...
							<li class="item_proceso_btn"  style="width:450px;" >
								...
								<input id="saveForm2" class="button_text" type="submit" name="saveForm" value="continuar" style="float:left;margin-top: 33px;" tabindex="9"/>
							</li>
		          	</li>
	          	</div>
				</td>
