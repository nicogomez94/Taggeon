                  ...
                  <div id="dropdown-user-menu">
                     <div class="media">
                        ...
                        <div class="media-body">
                          <h5 class="mt-0">Usuario Seller</h5>
                          <a href="/ampliar-usuario-seller.html">Ver Perfil Seller</a>
                        </div>
                      </div>
                     <hr>
                     <a href="/app/logout.php">Cerrar Session</a>
                  </div>
            </li>
               ...
               <div>
                  <div class="media">
                     ...
                     <div class="media-body">
                       ...
                       <a href="/ampliar-usuario-seller.html">Ver Perfil</a>
                     </div>
                   </div>
                  <hr>
                  <a href="/app/logout.php">Cerrar Session</a>
