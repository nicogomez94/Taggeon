...
<div id="form_container" style"height:400px;">
        ...
        <h1 id="paso1" class="titulo_procesos titulo_activo" style="z-index:10;background-color: #5F5F5F;">account settings</h1>
		  ...
		  <table width="795" border="0" align="center" cellpadding="0" cellspacing="2">
		    <tr align="left">
		      ...
		      <td width="122px"><span class="items_procesos">
		        <label class="description" for="pais">country</label>
	          </span></td>
		    ...
		    <tr align="left">
		      ...
		      <td><span class="items_procesos pass">
		        <label class="description" for="ciudad"><span class="items_procesos">city</label>
	          </span></td>
		      <td><span class="items_procesos pass">
		    ...
		    <tr align="left">
		      ...
		      <td><span class="items_procesos pass">
		        <label class="description" for="estado"><span class="items_procesos">state</label>
	          </span></td>
		      <td><span class="items_procesos pass">
		    ...
		    <tr align="left">
		      ...
		      <td><span class="items_procesos pass">
		        <label class="description" for="ciudad"><span class="items_procesos">zip code</label>
	          </span></td>
		      <td><span class="items_procesos pass">
		    ...
		    <tr align="left">
		      <td ><span class="items_procesos">
		        <label class="description" for="usuario">#Contact Phone</label>
	          </span></td>
		      <td ><span class="items_procesos">
		      ...
		      <td colspan="2" rowspan="2" align="rigth" valign="middle">
							<li class="item_proceso_btn" >
								<input id="saveForm2" class="button_text" type="submit" name="saveForm" value="continue" tabindex="9" style="float:left;margin-top: 10px;margin-left:10px;"/>
							</li>
	         </td>
	        </tr>
		    <tr align="left">
